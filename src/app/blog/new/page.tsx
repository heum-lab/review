...
export default async function NewPostPage({ searchParams }: NewPostPageProps): Promise<JSX.Element> {
        ...
        <div className="container-x py-16 sm:py-20">
          <div className="mx-auto max-w-3xl">
            <div className="flex items-center gap-3 text-sm text-ink-500">
              ...
              <span>·</span>
              <span className="text-ink-900">글쓰기</span>
            </div>
            ...
            <p className="mt-3 text-sm text-ink-500">
              <span className="font-semibold text-ink-700">{user.name}</span>님으로 글을 등록합니다.
            </p>
